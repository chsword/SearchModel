...
namespace Chsword.Web.Mvc.SearchModel.Binders
{
    /// <summary>
    ...
    public class SearchModelBinder : IModelBinder
    {
        public object BindModel(ControllerContext controllerContext, ModelBindingContext bindingContext) 
        {
            ...
            var model = (Chsword.SearchModel)(bindingContext.Model ?? new Chsword.SearchModel());
        ...
        public static void AddSearchItem(Chsword.SearchModel model, string key, string val)
        {
